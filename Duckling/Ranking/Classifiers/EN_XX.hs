...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5884986620842088, unseen = -5.749392985908253,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 312},
                   koData =
                     ClassData{prior = -0.8100409320314447, unseen = -5.529429087511423,
       ...
       ("in|within|after <duration>",
        Classifier{okData =
                     ClassData{prior = -0.13657553500575073,
                               unseen = -4.605170185988091,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.2088254890146994),
                                    ("<integer> more <unit-of-duration>", -3.9019726695746444),
                                    ("three-quarters of an hour", -3.2088254890146994),
                                    ("<integer> + '\"", -3.2088254890146994),
                                    ("number.number hours", -3.9019726695746444),
                                    ("second", -3.4965075614664802), ("day", -3.2088254890146994),
                                    ("half an hour", -2.9856819377004897),
                                    ("year", -3.9019726695746444),
                                    ("<integer> <unit-of-duration>", -1.550597412411167),
                                    ("a <unit-of-duration>", -2.9856819377004897),
                                    ("quarter of an hour", -3.2088254890146994),
                                    ("hour", -2.515678308454754),
                                    ("about|exactly <duration>", -3.9019726695746444),
                                    ("<integer> and an half hour", -3.9019726695746444),
                                    ("minute", -1.3370233121131079)],
                               n = 41},
                   koData =
                     ClassData{prior = -2.0583881324820035,
                               unseen = -3.4011973816621555,
                               likelihoods =
                                 HashMap.fromList
                                   [("year", -1.575536360758419),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.33024168687057687,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.12783337150988489),
                                    ("integer (0..19)", -2.120263536200091)],
                               n = 23}}),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.16598513747426116,
                               ...
                               n = 144},
                   koData =
                     ClassData{prior = -1.8777018990287797,
                               unseen = -3.4339872044851463,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.1416958748044215),
                                    ...
                                    ("year (grain)", -2.627081138568543),
                                    ("week (grain)", -1.1416958748044215),
                                    ("quarter", -3.16607763930123), ("year", -2.627081138568543),
                                    ("month", -2.8094026953624978),
                                    ("quarter (grain)", -3.16607763930123)],
                               n = 78},
                   koData =
                     ClassData{prior = -1.9459101490553135,
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.16315164068623442,
                               ...
                               n = 79},
                   koData =
                     ClassData{prior = -1.8935421635379972, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
