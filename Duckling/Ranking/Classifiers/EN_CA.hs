...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5784553374732347, unseen = -5.783825182329737,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 323},
                   koData =
                     ClassData{prior = -0.822718171968371, unseen = -5.541263545158426,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15057285847937432, unseen = -5.10594547390058,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 160},
                   koData =
                     ClassData{prior = -1.9676501356917193,
                               unseen = -3.4339872044851463,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.153672065851137),
                                    ...
                                    ("year (grain)", -2.559014621941722),
                                    ("week (grain)", -1.153672065851137),
                                    ("quarter", -3.1780538303479458), ("year", -2.559014621941722),
                                    ("month", -2.8213788864092133),
                                    ("quarter (grain)", -3.1780538303479458)],
                               n = 79},
                   koData =
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.17114825619582946,
                               ...
                               n = 75},
                   koData =
                     ClassData{prior = -1.8495790401168812, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
