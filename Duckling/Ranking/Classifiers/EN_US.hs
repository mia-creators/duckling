...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5651772995965687, unseen = -5.814130531825066,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 333},
                   koData =
                     ClassData{prior = -0.8399303008494924, unseen = -5.541263545158426,
       ...
       ("in|within|after <duration>",
        Classifier{okData =
                     ClassData{prior = -9.309042306601198e-2,
                               unseen = -4.59511985013459,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.1986731175506815),
                                    ("<integer> more <unit-of-duration>", -3.891820298110627),
                                    ("three-quarters of an hour", -3.1986731175506815),
                                    ("<integer> + '\"", -3.1986731175506815),
                                    ("number.number hours", -3.891820298110627),
                                    ("second", -3.4863551900024623), ("day", -3.1986731175506815),
                                    ("half an hour", -2.9755295662364714),
                                    ("year", -3.891820298110627),
                                    ("<integer> <unit-of-duration>", -1.540445040947149),
                                    ("a <unit-of-duration>", -2.9755295662364714),
                                    ("quarter of an hour", -3.1986731175506815),
                                    ("hour", -2.505525936990736),
                                    ("about|exactly <duration>", -3.891820298110627),
                                    ("<integer> and an half hour", -3.891820298110627),
                                    ("minute", -1.3268709406490897)],
                               n = 41},
                   koData =
                     ClassData{prior = -2.4203681286504293,
                               unseen = -3.2188758248682006,
                               likelihoods =
                                 HashMap.fromList
                                   [("year", -1.5686159179138452),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = 0.0, unseen = -1.9459101490553135,
                               likelihoods =
                                 HashMap.fromList
                                   [("week (grain)integer (numeric)year (latent)",
                                     -0.6931471805599453),
                                    ("weekyear", -0.6931471805599453)],
                               n = 2}}),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.1431008436406733, unseen = -5.159055299214529,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -3.529778208102382e-2),
                                    ("intersect 2 numbers", -3.7669972333778885)],
                               n = 169},
                   koData =
                     ClassData{prior = -2.0149030205422647,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.0033021088637848),
                                    ("negative numbers", -0.7621400520468967),
       ...
       ("week (grain)",
        Classifier{okData =
                     ClassData{prior = -6.291382541056932e-2,
                               unseen = -4.3694478524670215,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 77},
                   koData =
                     ClassData{prior = -2.797281334830153, unseen = -1.9459101490553135,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 5}}),
       ("<part-of-day> of <time>",
        Classifier{okData =
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.14884562759756517,
                               unseen = -5.153291594497779,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.1772025632613312),
                                    ("month (grain)", -2.8449093838194073),
                                    ("year (grain)", -2.439444275711243),
                                    ("week (grain)", -1.1772025632613312),
                                    ("quarter", -3.2015843277581397), ("year", -2.439444275711243),
                                    ("month", -2.8449093838194073),
                                    ("quarter (grain)", -3.2015843277581397)],
                               n = 81},
                   koData =
                     ClassData{prior = -1.978345424808467, unseen = -3.6109179126442243,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6343066805370119, unseen = -4.304065093204169,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.11607217125275401),
                                    ("integer (0..19)", -2.344549292093078)],
                               n = 70},
                   koData =
                     ClassData{prior = -0.7556675375412792, unseen = -4.189654742026425,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.169076330043934, unseen = -5.170483995038151,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 76},
                   koData =
                     ClassData{prior = -1.8607523407150064, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)quarter (grain)", -2.322387720290225),
                                    ("quarter", -2.322387720290225), ("hour", -1.5339303599259553),
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.2490672363240014, unseen = -5.365976015021851,
                               likelihoods =
                                 HashMap.fromList
                                   [("from|since|after <time>", -3.751854253275325),
                                    ("integer after|past <hour-of-day>", -3.9749978045895347),
                                    ("at <time-of-day>", -2.1424163408412245),
                                    ("<time-of-day> o'clock", -4.2626798770413155),
                                    ("half after|past <hour-of-day>", -4.2626798770413155),
                                    ("time-of-day (latent)", -1.6977305195797787),
                                    ("hhmm (latent)", -4.66814498514948),
                                    ("hh:mm", -2.316769727986002),
                                    ("until <time>", -3.9749978045895347),
                                    ("about|exactly <time-of-day>", -4.66814498514948),
                                    ("hour", -1.1716374236829996),
                                    ("<time-of-day> sharp|exactly", -4.66814498514948),
                                    ("minute", -1.8059441042200113)],
                               n = 99},
                   koData =
                     ClassData{prior = -1.5119825762833874, unseen = -4.276666119016055,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.164067588373206),
                                    ("from|since|after <time>", -3.164067588373206),
                                    ("<hour-of-day> <integer>", -3.56953269648137),
                                    ("time-of-day (latent)", -1.08462604669337),
                                    ("hour", -1.0438040521731147), ("minute", -2.653241964607215)],
                               n = 28}}),
       ("Yom Ha'atzmaut",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("Labor Day weekend",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ("<integer> quarter <year>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.3978952727983707,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)quarter (grain)year (latent)",
                                     -0.6931471805599453),
                                    ("quarteryear", -0.6931471805599453)],
                               n = 4},
                   koData =
